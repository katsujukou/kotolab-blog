...
// Language supports
import languageJavaScript from "shiki/langs/javascript.mjs"
import languageTypeScript from "shiki/langs/typescript.mjs"
import languagePureScript from "shiki/langs/purescript.mjs"
import languageOCaml from "shiki/langs/ocaml.mjs"
import languageNix from "shiki/langs/nix.mjs"

import shikiWasm from "shiki/wasm";

export const createHighlighterImpl = async () => createHighlighterCore({
  themes: [
    huacatPinkTheme
  ],
  langs: [
...
export const useHighlighterImpl = (md, highlighter, op) => md.use(fromHighlighter(highlighter, op))

const huacatPinkTheme = Object.freeze(JSON.parse(`
{
  "colors": {
    "foreground": "#72696f",
    "focusBorder": "#d4d4d4",
  ...
  "tokenColors": [
    ...
    {
      "name": "language-provided variables",
      "scope": [
        "variable.language"
      ],
      "settings": {
    ...
    {
      "name": "language-provided variables (Makefile)",
      "scope": [
